    ...
    public class TourViewModel : BaseViewModel
    {
       ...
       // Test
        ...
        public void Load()
        {
            ...
            this.Tours.Add(new TourWrapper(new Tour(0, "Tour1", "TD", "From", "To", 0.00, TransportType.Bike, "Image", logsOne)));
            ...
            this.Tours.Add(new TourWrapper(new Tour(1, "Tour2", "TD", "From", "To", 0.00, TransportType.Bike, "Image", logsTwo)));
            ...
            this.Tours.Add(new TourWrapper(new Tour(2, "Tour3", "TD", "From", "To", 0.00, TransportType.Bike, "Image", logsThree)));
        }
